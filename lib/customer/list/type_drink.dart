...
class _TypeDrink extends State<TypeDrink> with AutomaticKeepAliveClientMixin {
  ...
  _buttonSelectMenu(index) {
      if(valRadio == 0){
        ...
        context.read<MenuProvider>().addMenuToCart(addListMenu[index],forCheckName); /// Add cart menu by Provider.
                                        ...
                                        children: <Widget>[
                                          ...
                                          Padding(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                Container(
                                                  child: searchListMenu[index].priceMenuNormal==0 /// if (price_Normal == 0)
                                                      ? null
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              Text(
                                                "[${searchListMenu[index].statusSale}]",
                                                style: TextStyle(
                                                  color: Colors.red,
                                                  fontWeight: FontWeight.bold,
                                                  fontSize: 15,
